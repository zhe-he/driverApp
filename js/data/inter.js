...
const ADDREP=BASEINFO.host+'/Driver/report/add';//添加人工报修
const GETVEL=BASEINFO.host+'/app-dms/vehicle/getVelByField';//查询车辆信息
const GETREPORT=BASEINFO.host+'/Driver/report/getReport';//查询报修单详情
const REPLIST=BASEINFO.host+'/Driver/report/lists';//获取报修列表
